...
#include "org_exoplatform_services_security_pam_Pam.h"
#include <dlfcn.h>
#include <jni.h>
#include <ctype.h>
#include <string.h>
...
JNIEXPORT void JNICALL Java_org_exoplatform_services_security_pam_Pam_nativeMethod(JNIEnv *env, jobject obj) {
...
/*
 * Class:     org_exoplatform_services_security_pam_Pam
 * Method:    isSharedLibraryWorking
 * Signature: ()Z
 * Calls Pam.callback() to check that method callbacks into Java are working
 */
JNIEXPORT jboolean JNICALL Java_org_exoplatform_services_security_pam_Pam_isSharedLibraryWorking
(JNIEnv *env, jobject obj) {
  Java_org_exoplatform_services_security_pam_Pam_nativeMethod(env, obj);
  return JNI_TRUE;
}
 ...
 */
JNIEXPORT jint JNICALL Java_org_exoplatform_services_security_pam_Pam_authenticate
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_org_exoplatform_services_security_pam_Pam_groups
(JNIEnv *env, jobject jobj) {
  ...
  for(i = 0; i < ng; i++) {
    ...
    (env, jgroups, i, (*env)->NewStringUTF(env, getgrgid(groups[i])->gr_name));
  }

...
:ok
@set CLASSPATH=%CLASSPATH%%M2_REPO%\org\exoplatform\core\exo.core.component.security.core\2.1.5-SNAPSHOT\exo.core.component.security.core-2.1.5-SNAPSHOT.jar;
@set CLASSPATH=%CLASSPATH%%M2_REPO%\org\exoplatform\kernel\exo.kernel.component.common\2.0.7-SNAPSHOT\exo.kernel.component.common-2.0.7-SNAPSHOT.jar;

...
:ok
@set CLASSPATH=%CLASSPATH%%M2_REPO%\org\exoplatform\core\exo.core.component.security.core\2.1.5\exo.core.component.security.core-2.1.5.jar;
@set CLASSPATH=%CLASSPATH%%M2_REPO%\org\exoplatform\kernel\exo.kernel.component.common\2.0.7\exo.kernel.component.common-2.0.7.jar;

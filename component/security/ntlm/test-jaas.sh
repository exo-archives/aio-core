...
$JAVA_HOME/bin/java -cp $MAVEN_REPO/org/exoplatform/core/exo.core.component.security.core/2.1.5-SNAPSHOT/exo.core.component.security.core-2.1.5-SNAPSHOT.jar:\

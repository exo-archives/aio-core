...
$JAVA_HOME/bin/java -cp $MAVEN_REPO/org/exoplatform/core/exo.core.component.security.core/2.2.3-SNAPSHOT/exo.core.component.security.core-2.2.3-SNAPSHOT.jar:\
$MAVEN_REPO/org/exoplatform/kernel/exo.kernel.component.common/2.1.3-SNAPSHOT/exo.kernel.component.common-2.1.3-SNAPSHOT.jar:\

...
$JAVA_HOME/bin/java -cp $MAVEN_REPO/org/exoplatform/core/exo.core.component.security.core/2.1.7-SNAPSHOT/exo.core.component.security.core-2.1.7-SNAPSHOT.jar:\
$MAVEN_REPO/org/exoplatform/kernel/exo.kernel.component.common/2.0.8/exo.kernel.component.common-2.0.8.jar:\

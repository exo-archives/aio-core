...
public class TestOrganizationService extends BasicTestCase {
  ...
  // mtHandler_.createMembershipType(mt, true);
  //     
  // membershipHandler_.linkMembership( user,
  // groupHandler_.findGroupById("/"+Group1), mt, true);
  // membershipHandler_.linkMembership( user,
  // groupHandler_.findGroupById("/"+Group2), mt, true);
  // membershipHandler_.linkMembership( user2,
  // groupHandler_.findGroupById("/"+Group2), mt, true);
  //    
  // mt = mtHandler_.createMembershipTypeInstance() ;
  // mt.setName("membershipType2") ;
  // mtHandler_.createMembershipType(mt, true);
  // membershipHandler_.linkMembership( user, groupHandler_.findGroupById("/"+
  // Group2), mt, true);
  //    
  // mt = mtHandler_.createMembershipTypeInstance() ;
  ...
  // * Expect result: 4 membership: 3 for Benj(testmebership, membershipType2,
  // membershipType3)
  // * : 1 for Tuan(testmembership)
  // * */
  // System.out.println(" --------- find memberships by group -------------");
  // Collection<Membership> mems =
  // membershipHandler_.findMembershipsByGroup(groupHandler_
  ...
  // assertEquals("Expect number of membership in "+Group2+
  // " relate with benj is: ", 3, mems.size());
  //    
  // /* find all memberships of Benj in all group
  // * Expect result: 5 membership: 3 memberships in "Group2", 1 membership in
  // "Users" (default)
  ...
  // assertEquals("Expect membership type is: ", testType,
  // membership.getMembershipType()) ;
  // assertEquals("Expect groupId of this membership is: ","/"+Group2
  // ,membership.getGroupId());
  // assertEquals("Expect user of this membership is: ", Benj,
  // membership.getUserName());
  //
  // /* find all groups of Benj
  // * Expect result: 3 group: "Group1", "Group2" and "user" ("user" is default
  // group)
  // * */
  ...
  // assertTrue("This user was removed", userHandler_.findUserByName(Tuan)==
  // null) ;
  //     
  // mems = membershipHandler_.findMembershipsByUser(Tuan) ;
  // if(mems != null)assertTrue
  // ("All membership related with this user was removed:", mems.isEmpty()) ;
  //    
  // /* Remove a group
  ...
  // assertTrue ("This group was removed", groupHandler_.findGroupById("/" +
  // Group1)==null) ;
  //    
  ...
  // mtHandler_.findMembershipType(testType)==null) ;

 ...
 * Date: Aug 21, 2003
 * Time: 3:22:54 PM
 * This is the interface for a UserProfile data model. The implementor should have an user map info in
 * the implementation. The map  should only accept the java.lang.String for the key and the value.
 * Note that after the developer change the user information in the user info map, he need to call  
 * @see UserProfileHandler.saveUserProfile(UserProfile) to persist the change
 */
public interface UserProfile {
  /**
   * TODO Those keys should  be moved to the UserProfile portlet. The organization service should be 
   * generic.
   */
  
  /**
   * The predefine attributes of the user personal info. Those attributes are define in the JSR 168
   * specification
   */
  ...
  /**
   * The predefine attributes of the user home info. Those attributes are define in the JSR 168
   * specification
   */
 ...
 /**
  * The predefine attributes of the user businese info. Those attributes are define in the JSR 168
  * specification
  */
 ...
 /**
  * The predefine attributes of the exoplatform. Those keys are currently used in the exo forum
  */
  ...
  /**
   *@deprecated The third party developer should not used this method.  We should pass the username to 
   *the @see UserProfileHandler.createUserInstance() and set the username for the instance once only.
   */
  public void   setUserName(String username) ;
	
  /**
   * @return The map that contains  the user information. The map should only accept the java.lang.String
   * for the key and the value.
   */
  public Map<String, String>  getUserInfoMap()  ;
  /**
   * @param map  The map that contains the extra user information. The map should contains only the 

...
public class OrientationFilterTestCase extends TestCase {
  ...
  private static final String[] sheets = {
    "foo { width: 70%; /* orientation=lt */ width: 30%; }",
    "foo { width: 30%; }",

    "foo {}",
    "foo {}",

    "foo { padding-left: 3px; }",
    "foo { padding-right: 3px; }",

    "/* orientation=disable */ foo { padding-left: 3px; }",
    "foo { padding-left: 3px; }",
    ...
    "foo { padding-left: 3px; /* orientation=ignore */ }",
    "foo { padding-left: 3px; }",
    ...
    "foo { padding: 3px 2px 1px; }",
    "foo { padding: 3px 2px 1px; }",

    "foo { padding: 3px 2px 1px 0px; }",
    "foo { padding: 3px 0px 1px 2px; }",

    "foo { background: url(foo.gif) left; }",
    "foo { background: url(foo-rt.gif) right; }",

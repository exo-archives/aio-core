...
public class CSSSerializerTestCase extends TestCase {
  ...
  private static final String[] sheets = {
    ...
    "foo { padding-left: 2.2em }",
    "foo { float: left }",
    "foo { background: url('bar') repeat-x center top }",
    "foo { color: #202020 }",
    "foo { bar: juu(1, 2); }",
    "foo { padding: 3px; }",
    "foo { padding: 3px 2px; }",
    ...
    "foo { opacity: 0.92; }",
    "foo { display: inherit; }",
    "foo { font-family: \"Tahoma\",Geneva,Arial,Verdana,sans-serif; }",
    "foo { font-size: 10pt; }",
    "foo { margin-left: 10mm; }",
    "foo { margin-left: 10cm; }",
    "foo { width: 95%; }",
